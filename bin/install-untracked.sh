...
SKILL_DIRS=(save)
BIN_FILES=(copy-for-web.sh plan-prompt.md result-prompt.md save-plan.sh save-followup.sh attach.sh lean-note.md lib/common.sh lib/copy-for-web-lib.sh lib/copy-for-web-design.sh lib/copy-for-web-result.sh lib/copy-for-web-modes.sh lib/copy-for-web-lean.sh lib/copy-for-web-handoff.sh lib/save-plan-lib.sh)
